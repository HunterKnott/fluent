...
export default function Hero() {
    return (
        <div className="max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col gap-6 justify-center">
            ...
            <div className="flex flex-row gap-8 justify-center items-center">
                <button className="bg-green-500 w-[200px] rounded-md font-medium my-6 py-3">Get Started</button>
                <Link href={"Home"}>
