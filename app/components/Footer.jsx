...
export default function Footer() {
    return (
        <div className="flex flex-col gap-8 items-center w-full py-16 px-20" style= {{backgroundColor: "#222222", color: "white"}}>
            ...
            <div className="flex flex-row gap-8 justify-center items-center">
                <button className="bg-gray-100 w-[200px] rounded-md font-medium my-6 py-3 text-gray-800">Get Started</button>
                <Link href={"Home"}>
